# Chương trình tìm top k giá trị lớn nhất
#
# Yêu cầu:
# - Viết chương trình lấy k giá trị lớn nhất trong list số.
...
if k <= 0:
    ...
    ket_qua = sorted(danh_sach, reverse=True)[:k]
    print(f"Top {k} giá trị lớn nhất:", dinh_dang_list(ket_qua))
