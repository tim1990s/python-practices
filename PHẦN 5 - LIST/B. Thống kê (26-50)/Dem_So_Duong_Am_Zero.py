# Chương trình đếm số dương, âm và bằng 0
#
# Yêu cầu:
# - Viết chương trình đếm số lượng số dương, số âm và số bằng 0 trong list.
...
# - Tăng biến đếm theo từng loại giá trị.
...
so_duong = sum(1 for so in danh_sach if so > 0)
so_am = sum(1 for so in danh_sach if so < 0)
so_khong = sum(1 for so in danh_sach if so == 0)
print("Số dương:", so_duong)
print("Số âm:", so_am)
print("Số bằng 0:", so_khong)
