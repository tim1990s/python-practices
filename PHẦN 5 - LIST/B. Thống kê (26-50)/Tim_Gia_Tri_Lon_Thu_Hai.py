# Chương trình tìm giá trị lớn thứ hai
#
# Yêu cầu:
# - Viết chương trình tìm giá trị lớn thứ hai trong list số.
...
# - Đọc list số.
# - Loại trùng bằng set().
# - Sắp xếp tăng dần và lấy phần tử áp chót.
...
gia_tri_khac_nhau = sorted(set(danh_sach))

if len(gia_tri_khac_nhau) < 2:
    print("Không có giá trị lớn thứ hai")
else:
    print("Giá trị lớn thứ hai:", dinh_dang_so(gia_tri_khac_nhau[-2]))
