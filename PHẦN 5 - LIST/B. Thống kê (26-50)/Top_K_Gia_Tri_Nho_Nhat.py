# Chương trình tìm top k giá trị nhỏ nhất
#
# Yêu cầu:
# - Viết chương trình lấy k giá trị nhỏ nhất trong list số.
...
if k <= 0:
    ...
    ket_qua = sorted(danh_sach)[:k]
    print(f"Top {k} giá trị nhỏ nhất:", dinh_dang_list(ket_qua))
