# Chương trình tính khoảng biến thiên
#
# Yêu cầu:
# - Viết chương trình tính range bằng max trừ min của list số.
...
if not danh_sach:
    print("Không thể tính range của list rỗng")
else:
    khoang_bien_thien = max(danh_sach) - min(danh_sach)
    print("Range:", dinh_dang_so(khoang_bien_thien))
