# Chương trình tìm giá trị nhỏ nhất trong list
#
# Yêu cầu:
# - Viết chương trình tìm giá trị nhỏ nhất trong list số.
...
# - Dùng min() để tìm giá trị nhỏ nhất.
...
if not danh_sach:
    ...
    print("Giá trị nhỏ nhất:", dinh_dang_so(min(danh_sach)))
