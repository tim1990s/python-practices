# Chương trình tính tổng tích lũy
#
# Yêu cầu:
# - Viết chương trình tạo list tổng tích lũy từ list số.
...
# - Thêm tổng hiện tại vào list kết quả.
...
for gia_tri in danh_sach:
    ...
    ket_qua.append(tong_hien_tai)

print("List tổng tích lũy:", dinh_dang_list(ket_qua))
