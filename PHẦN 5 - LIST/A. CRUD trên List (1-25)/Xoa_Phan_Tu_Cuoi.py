# Chương trình xóa phần tử cuối list
#
# Yêu cầu:
# - Viết chương trình xóa phần tử cuối cùng của list.
...
if danh_sach:
    phan_tu_da_xoa = danh_sach.pop()
    print("Phần tử cuối đã xóa:", phan_tu_da_xoa)
