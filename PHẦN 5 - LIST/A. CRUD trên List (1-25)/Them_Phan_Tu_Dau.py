# Chương trình thêm phần tử vào đầu list
#
# Yêu cầu:
# - Viết chương trình thêm một phần tử vào đầu list.
...
# - Dùng insert(0, giá trị) để chèn vào đầu list.
...
phan_tu = input("Nhập phần tử cần thêm vào đầu: ")
danh_sach.insert(0, phan_tu)
print("List sau khi thêm vào đầu:", danh_sach)
