# Chương trình sắp xếp list giảm dần
#
# Yêu cầu:
# - Viết chương trình sắp xếp list số theo thứ tự giảm dần.
...
ket_qua = sorted(danh_sach, reverse=True)
print("List giảm dần:", dinh_dang_list(ket_qua))
