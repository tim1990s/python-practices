# Chương trình tính prefix sum
#
# Yêu cầu:
# - Viết chương trình tạo list tổng tiền tố từ list số.
...
# Ý tưởng:
# - Đọc list số nguyên.
# - Cộng dồn từ trái sang phải.
# - Lưu tổng hiện tại vào list kết quả.
