# 023. Đếm tần suất xuất hiện

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Đếm tần suất xuất hiện` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: dict, get(), sorted(). Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Tần suất xuất hiện.
        ...
        List cho phép lưu nhiều giá trị trong cùng một biến và xử lý chúng như một dãy. Khi làm việc với list, người học cần tập trung vào thứ tự phần tử, cách duyệt, cách tích lũy kết quả và cách chọn cấu trúc phụ như set hoặc dictionary khi bài toán cần kiểm tra trùng lặp hay đếm tần suất.

        Trong bài này, các chủ đề Python chính là dict, get(), sorted(). Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Tần suất xuất hiện. Với các bài
        ...
        Khi gặp một bài toán như `Đếm tần suất xuất hiện`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập n và n số nguyên, đếm số lần xuất hiện của từng giá trị. In các giá trị theo thứ tự tăng dần, mỗi dòng gồm giá trị và số lần xuất hiện.
        ...
        Dòng thứ nhất là số nguyên n. Dòng thứ hai gồm n số nguyên.
        ...
        Nhiều dòng, mỗi dòng gồm value count theo thứ tự value tăng dần.
...
3 2
        ...
        Số 1 xuất hiện 2 lần, số 2 xuất hiện 3 lần, số 3 xuất hiện 2 lần.
        ...
        1. Đọc n và list gồm n số nguyên.
2. Duyệt list và cập nhật số lần xuất hiện trong dictionary.
3. Duyệt các khóa đã sắp xếp tăng dần.
4. In mỗi giá trị cùng tần suất của nó.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: dict, get(), sorted().
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Tần suất xuất hiện. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: List, Dictionary, Vòng lặp. Khi gặp bài tương tự,
