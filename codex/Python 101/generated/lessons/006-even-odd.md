# 006. Kiểm tra chẵn lẻ

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Kiểm tra chẵn lẻ` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: toán tử %, if, else. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Tính chẵn lẻ.
        ...
        Trong bài này, các chủ đề Python chính là toán tử %, if, else. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Tính chẵn lẻ. Với các bài
        ...
        Khi gặp một bài toán như `Kiểm tra chẵn lẻ`, bạn nên tự hỏi: đại lượng nào
        ...
        In EVEN nếu n chẵn, ngược lại in ODD.
        ...
        12 chia hết cho 2 nên là số chẵn.
        ...
        1. Đọc số nguyên n.
2. Tính n chia lấy dư cho 2.
3. Nếu phần dư bằng 0 thì in EVEN.
4. Ngược lại in ODD.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: toán tử %, if, else.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Tính chẵn lẻ. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên, Phép chia lấy dư, if else. Khi gặp bài tương tự,
