# 009. Phân loại điểm số

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Phân loại điểm số` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: float(), if, elif, else. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Khoảng giá trị.
        ...
        Trong bài này, các chủ đề Python chính là float(), if, elif, else. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Khoảng giá trị. Với các bài
        ...
        Khi gặp một bài toán như `Phân loại điểm số`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập điểm số từ 0 đến 10 và phân loại kết quả học tập.
        ...
        In INVALID nếu điểm ngoài khoảng 0 đến 10; EXCELLENT nếu điểm từ 8.5; GOOD nếu từ 7.0; AVERAGE nếu từ 5.0; ngược lại BELOW AVERAGE.
        ...
        8.7 nằm trong khoảng từ 8.5 đến 10 nên được phân loại EXCELLENT.
        ...
        1. Đọc điểm dưới dạng số thực.
2. Kiểm tra điểm có nằm ngoài khoảng 0 đến 10 hay không.
3. So sánh điểm với từng ngưỡng từ cao xuống thấp.
4. In nhãn phân loại tương ứng.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: float(), if, elif, else.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Khoảng giá trị. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số thực, So sánh, elif. Khi gặp bài tương tự,
