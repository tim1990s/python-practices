# 028. Hàm kiểm tra mật khẩu hợp lệ

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Hàm kiểm tra mật khẩu hợp lệ` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: def, any(), islower(), isupper(), isdigit(). Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Logic nhiều điều kiện.
        ...
        Trong bài này, các chủ đề Python chính là def, any(), islower(), isupper(), isdigit(). Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Logic nhiều điều kiện. Với các bài
        ...
        Khi gặp một bài toán như `Hàm kiểm tra mật khẩu hợp lệ`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một mật khẩu, viết hàm kiểm tra mật khẩu hợp lệ nếu có ít nhất 8 ký tự, có chữ thường, chữ hoa, chữ số và ký tự đặc biệt.
        ...
        In VALID nếu mật khẩu hợp lệ, ngược lại in INVALID.
        ...
        Mật khẩu đủ dài và có chữ hoa, chữ thường, chữ số, ký tự đặc biệt.
...
3. Kiểm tra độ dài và từng nhóm ký tự bắt buộc.
4. Trả về True nếu mọi điều kiện đều đúng.
5. In VALID hoặc INVALID.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: def, any(), islower(), isupper(), isdigit().
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Logic nhiều điều kiện. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Hàm, Chuỗi, Điều kiện, any(). Khi gặp bài tương tự,
