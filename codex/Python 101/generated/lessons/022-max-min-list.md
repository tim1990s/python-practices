# 022. Tìm giá trị nhỏ nhất và lớn nhất trong list

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Tìm giá trị nhỏ nhất và lớn nhất trong list` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: list, min(), max(). Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Giá trị cực trị trong dãy.
        ...
        Trong bài này, các chủ đề Python chính là list, min(), max(). Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Giá trị cực trị trong dãy. Với các bài
        ...
        Khi gặp một bài toán như `Tìm giá trị nhỏ nhất và lớn nhất trong list`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập n và n số nguyên, in ra giá trị nhỏ nhất và lớn nhất.
        ...
        Dòng thứ nhất là số nguyên dương n. Dòng thứ hai gồm n số nguyên.
        ...
        Hai số nguyên: nhỏ nhất và lớn nhất.
...
4 -1 9 9 2 0
        ...
        Số nhỏ nhất là -1 và số lớn nhất là 9.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: list, min(), max().
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Giá trị cực trị trong dãy. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: List, So sánh, for. Khi gặp bài tương tự,
