# 024. Loại bỏ phần tử trùng lặp

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Loại bỏ phần tử trùng lặp` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: set, append(), in. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Tập hợp và thứ tự xuất hiện.
        ...
        Trong bài này, các chủ đề Python chính là set, append(), in. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Tập hợp và thứ tự xuất hiện. Với các bài
        ...
        Khi gặp một bài toán như `Loại bỏ phần tử trùng lặp`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập n và n số nguyên, loại bỏ các phần tử trùng lặp nhưng giữ lại thứ tự xuất hiện đầu tiên.
        ...
        Một dòng gồm các phần tử sau khi loại trùng, cách nhau bởi dấu cách.
...
5 1 5 2 1 3 2 4
        ...
        Mỗi giá trị chỉ được giữ ở lần xuất hiện đầu tiên.
...
2. Tạo set để ghi nhớ giá trị đã gặp.
3. Duyệt list theo thứ tự ban đầu.
4. Nếu giá trị chưa gặp, thêm vào kết quả và đánh dấu đã gặp.
5. In list kết quả.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: set, append(), in.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Tập hợp và thứ tự xuất hiện. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: List, Set, Vòng lặp. Khi gặp bài tương tự,
