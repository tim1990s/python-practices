# 004. Trung bình cộng của ba số

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Trung bình cộng của ba số` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: float(), split(), toán tử /, định dạng .2f. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Trung bình cộng.
        ...
        Trong bài này, các chủ đề Python chính là float(), split(), toán tử /, định dạng .2f. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Trung bình cộng. Với các bài
        ...
        Khi gặp một bài toán như `Trung bình cộng của ba số`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập ba số thực, sau đó in ra trung bình cộng của ba số đó với 2 chữ số thập phân.
        ...
        Một số thực là trung bình cộng, làm tròn 2 chữ số thập phân.
...
2. Cộng ba số lại.
3. Chia tổng cho 3.
4. In trung bình với 2 chữ số thập phân.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: float(), split(), toán tử /, định dạng .2f.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Trung bình cộng. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số thực, Phép cộng, Phép chia. Khi gặp bài tương tự,
