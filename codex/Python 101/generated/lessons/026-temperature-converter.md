# 026. Hàm chuyển đổi nhiệt độ

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Hàm chuyển đổi nhiệt độ` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: def, return, float(), f-string. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Chuyển đổi Celsius và Fahrenheit.
        ...
        Trong bài này, các chủ đề Python chính là def, return, float(), f-string. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Chuyển đổi Celsius và Fahrenheit. Với các bài
        ...
        Khi gặp một bài toán như `Hàm chuyển đổi nhiệt độ`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập nhiệt độ Celsius, viết hàm chuyển sang Fahrenheit và in kết quả với 2 chữ số thập phân.
        ...
        Một số thực là nhiệt độ Fahrenheit, làm tròn 2 chữ số thập phân.
        ...
        F = C * 9 / 5 + 32, nên 25 độ C bằng 77 độ F.
        ...
        1. Đọc nhiệt độ Celsius.
2. Gọi hàm chuyển đổi sang Fahrenheit.
3. Trong hàm, áp dụng công thức C * 9 / 5 + 32.
4. In kết quả với 2 chữ số thập phân.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: def, return, float(), f-string.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Chuyển đổi Celsius và Fahrenheit. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Hàm, Số thực, Công thức tuyến tính. Khi gặp bài tương tự,
