# 029. Hàm tìm kiếm tuyến tính

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Hàm tìm kiếm tuyến tính` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: def, list[int], enumerate(), return. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Tìm kiếm trong dãy hữu hạn.
        ...
        Trong bài này, các chủ đề Python chính là def, list[int], enumerate(), return. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Tìm kiếm trong dãy hữu hạn. Với các bài
        ...
        Khi gặp một bài toán như `Hàm tìm kiếm tuyến tính`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập n, list gồm n số nguyên và giá trị target, viết hàm tìm vị trí xuất hiện đầu tiên của target. Nếu không có thì trả về -1.
        ...
        Dòng thứ nhất là n. Dòng thứ hai gồm n số nguyên. Dòng thứ ba là target.
        ...
        Một số nguyên là chỉ số đầu tiên theo 0-based index, hoặc -1 nếu không tìm thấy.
...
15
        ...
        Giá trị 15 xuất hiện đầu tiên tại chỉ số 2.
        ...
        1. Đọc n, list số nguyên và target.
2. Gọi hàm linear_search.
3. Duyệt list bằng enumerate để có cả chỉ số và giá trị.
4. Trả về chỉ số đầu tiên khi tìm thấy target.
5. Nếu duyệt hết mà không thấy, trả về -1.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: def, list[int], enumerate(), return.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Tìm kiếm trong dãy hữu hạn. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Hàm, List, Vòng lặp. Khi gặp bài tương tự,
