# 010. Phân loại tam giác

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Phân loại tam giác` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: int(), sorted(), if, elif. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Bất đẳng thức tam giác, Tam giác đều, Tam giác cân, Tam giác thường.
        ...
        Ở module điều kiện, chương trình không còn chạy một đường thẳng duy nhất. Python phải chọn nhánh dựa trên kết quả của biểu thức boolean. Điều quan trọng là viết điều kiện sao cho phản ánh đúng quy tắc của bài toán, đồng thời sắp xếp các nhánh từ trường hợp đặc biệt đến trường hợp tổng quát để tránh kết quả sai.

        Trong bài này, các chủ đề Python chính là int(), sorted(), if, elif. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Bất đẳng thức tam giác, Tam giác đều, Tam giác cân, Tam giác thường. Với các bài
        ...
        Khi gặp một bài toán như `Phân loại tam giác`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập ba cạnh của một tam giác, kiểm tra chúng có tạo thành tam giác không và phân loại tam giác.
        ...
        Một dòng gồm ba số nguyên dương a, b và c.
        ...
        In NOT TRIANGLE nếu không tạo thành tam giác; EQUILATERAL nếu tam giác đều; ISOSCELES nếu tam giác cân; SCALENE nếu tam giác thường.
        ...
        Ba cạnh 5, 5, 8 tạo thành tam giác và có hai cạnh bằng nhau.
        ...
        1. Đọc ba cạnh và sắp xếp theo thứ tự tăng dần.
2. Kiểm tra cạnh nhỏ nhất có dương và hai cạnh nhỏ có lớn hơn cạnh lớn không.
3. Nếu không hợp lệ thì in NOT TRIANGLE.
4. Nếu hợp lệ, so sánh các cạnh để phân loại đều, cân hoặc thường.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: int(), sorted(), if, elif.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Bất đẳng thức tam giác, Tam giác đều, Tam giác cân, Tam giác thường. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Bất đẳng thức tam giác, if elif else, and. Khi gặp bài tương tự,
