# 007. Tìm số nhỏ nhất và lớn nhất trong ba số

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Tìm số nhỏ nhất và lớn nhất trong ba số` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: min(), max(), split(). Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Thứ tự trên tập số nguyên.
        ...
        Trong bài này, các chủ đề Python chính là min(), max(), split(). Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Thứ tự trên tập số nguyên. Với các bài
        ...
        Khi gặp một bài toán như `Tìm số nhỏ nhất và lớn nhất trong ba số`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập ba số nguyên a, b, c, sau đó in ra số nhỏ nhất và số lớn nhất.
        ...
        Một dòng gồm ba số nguyên a, b và c.
        ...
        Hai số nguyên: giá trị nhỏ nhất và giá trị lớn nhất.
        ...
        Trong ba số 4, -2 và 9, nhỏ nhất là -2 và lớn nhất là 9.
...
4. In hai giá trị theo thứ tự nhỏ nhất rồi lớn nhất.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: min(), max(), split().
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Thứ tự trên tập số nguyên. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên, So sánh, if elif else. Khi gặp bài tương tự,
