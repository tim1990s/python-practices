# 013. Đếm số chữ số
        ...
        `Đếm số chữ số` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: while, abs(), toán tử //. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Biểu diễn thập phân của số nguyên.
        ...
        Trong bài này, các chủ đề Python chính là while, abs(), toán tử //. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Biểu diễn thập phân của số nguyên. Với các bài
        ...
        Khi gặp một bài toán như `Đếm số chữ số`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một số nguyên n, đếm số chữ số trong biểu diễn thập phân của n.
        ...
        Một số nguyên là số chữ số của n.
        ...
        1. Đọc số nguyên n và lấy trị tuyệt đối.
2. Nếu n bằng 0 thì số chữ số là 1.
3. Nếu không, lặp khi n còn lớn hơn 0.
4. Mỗi vòng chia nguyên n cho 10 và tăng biến đếm.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: while, abs(), toán tử //.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Biểu diễn thập phân của số nguyên. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên, Phép chia nguyên, while. Khi gặp bài tương tự,
