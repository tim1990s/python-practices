# 002. Diện tích hình chữ nhật

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Diện tích hình chữ nhật` không chỉ như một yêu cầu tính kết quả, mà như một
        ...
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Diện tích hình chữ nhật.
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Diện tích hình chữ nhật. Với các bài
        ...
        Khi gặp một bài toán như `Diện tích hình chữ nhật`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập chiều dài và chiều rộng của một hình chữ nhật, sau đó in ra diện tích.
        ...
        Một dòng gồm hai số nguyên dương length và width.
        ...
        Một số nguyên là diện tích hình chữ nhật.
        ...
        Diện tích bằng chiều dài nhân chiều rộng: 7 * 4 = 28.
        ...
        1. Đọc chiều dài và chiều rộng.
2. Nhân hai giá trị để lấy diện tích.
3. In diện tích.
...
if __name__ == "__main__":
    main()
        ...
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Diện tích hình chữ nhật. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Biến, Số nguyên, Phép nhân. Khi gặp bài tương tự,
