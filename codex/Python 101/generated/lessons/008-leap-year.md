# 008. Kiểm tra năm nhuận

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Kiểm tra năm nhuận` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: if, and, or, toán tử %. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Quy tắc năm nhuận Gregorian.
        ...
        Trong bài này, các chủ đề Python chính là if, and, or, toán tử %. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Quy tắc năm nhuận Gregorian. Với các bài
        ...
        Khi gặp một bài toán như `Kiểm tra năm nhuận`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một năm, kiểm tra năm đó có phải là năm nhuận theo lịch Gregorian hay không.
        ...
        In LEAP nếu là năm nhuận, ngược lại in COMMON.
        ...
        1. Đọc năm cần kiểm tra.
2. Kiểm tra năm chia hết cho 400.
3. Nếu không, kiểm tra năm chia hết cho 4 và không chia hết cho 100.
4. In LEAP nếu một trong hai điều kiện đúng, ngược lại in COMMON.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: if, and, or, toán tử %.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Quy tắc năm nhuận Gregorian. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên, Phép chia hết, and, or. Khi gặp bài tương tự,
