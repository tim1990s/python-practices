# 012. Tính giai thừa
        ...
        `Tính giai thừa` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: for, range(), biến product. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Giai thừa.
        ...
        Trong bài này, các chủ đề Python chính là for, range(), biến product. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Giai thừa. Với các bài
        ...
        Khi gặp một bài toán như `Tính giai thừa`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập số nguyên không âm n, tính n!.
        ...
        1. Đọc số nguyên không âm n.
2. Khởi tạo kết quả bằng 1.
3. Nhân kết quả lần lượt với các số từ 2 đến n.
4. In kết quả.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: for, range(), biến product.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Giai thừa. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên không âm, Vòng lặp for, Phép nhân. Khi gặp bài tương tự,
