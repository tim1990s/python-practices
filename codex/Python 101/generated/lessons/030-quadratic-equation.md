# 030. Hàm giải phương trình bậc hai

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Hàm giải phương trình bậc hai` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: def, tuple, math.sqrt(), if elif else. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Phương trình bậc hai, Biệt thức delta.
        ...
        Hàm là công cụ để chia chương trình thành các khối nhỏ có tên gọi rõ ràng. Một hàm tốt nhận dữ liệu qua tham số, xử lý một nhiệm vụ cụ thể và trả về kết quả. Cách viết này giúp chương trình dễ đọc, dễ kiểm thử và dễ mở rộng khi bài toán lớn hơn.

        Trong bài này, các chủ đề Python chính là def, tuple, math.sqrt(), if elif else. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Phương trình bậc hai, Biệt thức delta. Với các bài
        ...
        Khi gặp một bài toán như `Hàm giải phương trình bậc hai`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập ba hệ số a, b, c của phương trình ax^2 + bx + c = 0, viết hàm phân loại và tính nghiệm thực nếu có.
        ...
        Một dòng gồm ba số thực a, b và c.
        ...
        Nếu vô số nghiệm in Infinite solutions. Nếu vô nghiệm in No solution hoặc No real roots tùy trường hợp. Nếu có một nghiệm in One root: x = value. Nếu có hai nghiệm in Two roots: x1 = value, x2 = value. Các nghiệm làm tròn 2 chữ số thập phân.
        ...
        ```text
        Two roots: x1 = 1.00, x2 = 2.00
        ```

        Explanation:

        Delta = 1, hai nghiệm thực là 1 và 2.
        ...
        1. Đọc ba hệ số a, b, c.
2. Nếu a bằng 0, xử lý như phương trình bậc nhất hoặc hằng.
3. Nếu a khác 0, tính delta = b^2 - 4ac.
4. Dựa trên delta để xác định vô nghiệm thực, nghiệm kép hoặc hai nghiệm.
5. Tính nghiệm và in theo định dạng yêu cầu.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: def, tuple, math.sqrt(), if elif else.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Phương trình bậc hai, Biệt thức delta. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Hàm, Điều kiện, Căn bậc hai, Số thực. Khi gặp bài tương tự,
