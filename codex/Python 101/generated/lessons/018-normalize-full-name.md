# 018. Chuẩn hóa họ tên

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Chuẩn hóa họ tên` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: strip(), split(), capitalize(), join(). Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Chuẩn hóa dữ liệu theo quy tắc.
        ...
        Trong bài này, các chủ đề Python chính là strip(), split(), capitalize(), join(). Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Chuẩn hóa dữ liệu theo quy tắc. Với các bài
        ...
        Khi gặp một bài toán như `Chuẩn hóa họ tên`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một họ tên có thể thừa khoảng trắng và sai hoa thường, chuẩn hóa để mỗi từ viết hoa chữ cái đầu và các chữ còn lại viết thường.
        ...
        Các khoảng trắng thừa được bỏ, mỗi từ được chuyển về dạng chữ cái đầu viết hoa.
        ...
        1. Đọc họ tên.
2. Tách chuỗi thành các từ, tự động bỏ khoảng trắng thừa.
3. Chuẩn hóa từng từ về dạng chữ cái đầu viết hoa.
4. Ghép các từ bằng một dấu cách.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: strip(), split(), capitalize(), join().
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Chuẩn hóa dữ liệu theo quy tắc. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Chuỗi, split(), join(). Khi gặp bài tương tự,
