# 020. Mã hóa Caesar
        ...
        `Mã hóa Caesar` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: ord(), chr(), isalpha(), modulo. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Dịch vòng trong bảng chữ cái.
        ...
        Chuỗi trong Python là một dãy ký tự có thứ tự. Xử lý chuỗi thường bao gồm các bước làm sạch dữ liệu, duyệt từng ký tự hoặc từng từ, kiểm tra điều kiện và ghép kết quả. Đây là kỹ năng rất thực tế vì dữ liệu người dùng nhập vào hiếm khi sạch hoàn toàn.

        Trong bài này, các chủ đề Python chính là ord(), chr(), isalpha(), modulo. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Dịch vòng trong bảng chữ cái. Với các bài
        ...
        Khi gặp một bài toán như `Mã hóa Caesar`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một chuỗi và số nguyên shift, mã hóa chuỗi bằng Caesar cipher. Chữ cái được dịch vòng trong bảng chữ cái, giữ nguyên hoa thường; ký tự không phải chữ cái giữ nguyên.
        ...
        Dòng thứ nhất là chuỗi cần mã hóa. Dòng thứ hai là số nguyên shift.
...
2
        ...
        A dịch thành C, b thành d, c thành e, Z dịch vòng thành B, z dịch vòng thành b.
        ...
        1. Đọc chuỗi cần mã hóa và độ dịch shift.
2. Duyệt từng ký tự trong chuỗi.
3. Nếu là chữ cái, dịch vòng trong bảng chữ cái phù hợp với hoa hoặc thường.
4. Nếu không phải chữ cái, giữ nguyên.
5. Ghép các ký tự đã xử lý và in kết quả.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: ord(), chr(), isalpha(), modulo.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Dịch vòng trong bảng chữ cái. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Chuỗi, Vòng lặp, Mã ASCII, Phép chia lấy dư. Khi gặp bài tương tự,
