# 005. Kiểm tra số chính phương

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Kiểm tra số chính phương` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: int(), math.isqrt(), if đơn giản. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Số chính phương, Căn bậc hai nguyên.
        ...
        Trong bài này, các chủ đề Python chính là int(), math.isqrt(), if đơn giản. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Số chính phương, Căn bậc hai nguyên. Với các bài
        ...
        Khi gặp một bài toán như `Kiểm tra số chính phương`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một số nguyên không âm n, kiểm tra n có phải là số chính phương hay không.
        ...
        In YES nếu n là số chính phương, ngược lại in NO.
        ...
        49 = 7 * 7 nên 49 là số chính phương.
        ...
        1. Đọc số nguyên n.
2. Tính căn bậc hai nguyên của n.
3. Bình phương căn nguyên vừa tìm được.
4. So sánh với n để quyết định YES hoặc NO.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: int(), math.isqrt(), if đơn giản.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Số chính phương, Căn bậc hai nguyên. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên, Căn bậc hai, So sánh. Khi gặp bài tương tự,
