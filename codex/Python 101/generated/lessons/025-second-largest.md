# 025. Tìm số lớn thứ hai

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Tìm số lớn thứ hai` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: set(), sorted(), reverse=True. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Thứ hạng trong dãy số.
        ...
        Trong bài này, các chủ đề Python chính là set(), sorted(), reverse=True. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Thứ hạng trong dãy số. Với các bài
        ...
        Khi gặp một bài toán như `Tìm số lớn thứ hai`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập n và n số nguyên, tìm giá trị lớn thứ hai khác với giá trị lớn nhất.
        ...
        In số lớn thứ hai nếu tồn tại, ngược lại in NO SECOND LARGEST.
...
10 5 10 8 7 8
        ...
        Các giá trị khác nhau là 10, 8, 7, 5; số lớn thứ hai là 8.
...
2. Loại trùng các giá trị.
3. Sắp xếp các giá trị khác nhau theo thứ tự giảm dần.
4. Nếu có ít nhất hai giá trị, in giá trị thứ hai; ngược lại in thông báo.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: set(), sorted(), reverse=True.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Thứ hạng trong dãy số. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: List, Set, Sắp xếp, Điều kiện. Khi gặp bài tương tự,
