# 021. Tính tổng các phần tử trong list

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Tính tổng các phần tử trong list` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: list, map(), sum(). Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Tổng của dãy số.
        ...
        Trong bài này, các chủ đề Python chính là list, map(), sum(). Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Tổng của dãy số. Với các bài
        ...
        Khi gặp một bài toán như `Tính tổng các phần tử trong list`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập n và n số nguyên, tính tổng các phần tử trong list.
...
2. Khởi tạo tổng bằng 0 hoặc dùng hàm sum.
3. Cộng toàn bộ phần tử trong list.
4. In tổng.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: list, map(), sum().
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Tổng của dãy số. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: List, Vòng lặp for, Biến tổng. Khi gặp bài tương tự,
