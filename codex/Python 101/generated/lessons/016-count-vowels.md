# 016. Đếm nguyên âm trong chuỗi

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Đếm nguyên âm trong chuỗi` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: for, lower(), in. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Đếm phần tử thỏa điều kiện.
        ...
        Trong bài này, các chủ đề Python chính là for, lower(), in. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Đếm phần tử thỏa điều kiện. Với các bài
        ...
        Khi gặp một bài toán như `Đếm nguyên âm trong chuỗi`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một chuỗi, đếm số ký tự nguyên âm tiếng Anh a, e, i, o, u trong chuỗi, không phân biệt hoa thường.
        ...
        Các nguyên âm là o, i, u nên có 3 ký tự.
        ...
        1. Đọc chuỗi đầu vào.
2. Chuyển từng ký tự về chữ thường khi kiểm tra.
3. Nếu ký tự thuộc tập nguyên âm thì tăng biến đếm.
4. In số lượng nguyên âm.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: for, lower(), in.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Đếm phần tử thỏa điều kiện. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Chuỗi, Vòng lặp for, if. Khi gặp bài tương tự,
