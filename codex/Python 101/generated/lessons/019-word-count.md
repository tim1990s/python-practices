# 019. Đếm số từ trong câu

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Đếm số từ trong câu` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: strip(), split(), len(). Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Đếm phần tử sau khi tách.
        ...
        Trong bài này, các chủ đề Python chính là strip(), split(), len(). Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Đếm phần tử sau khi tách. Với các bài
        ...
        Khi gặp một bài toán như `Đếm số từ trong câu`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một câu, đếm số từ trong câu. Các từ được phân tách bởi một hoặc nhiều khoảng trắng.
        ...
        Câu có bốn từ: Python, makes, practice, clear.
        ...
        1. Đọc câu đầu vào.
2. Dùng split để tách theo khoảng trắng.
3. Đếm số phần tử sau khi tách.
4. In kết quả.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: strip(), split(), len().
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Đếm phần tử sau khi tách. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Chuỗi, split(). Khi gặp bài tương tự,
