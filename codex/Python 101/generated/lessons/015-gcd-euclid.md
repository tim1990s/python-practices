# 015. Ước chung lớn nhất bằng thuật toán Euclid

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Ước chung lớn nhất bằng thuật toán Euclid` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: while, toán tử %, tuple assignment. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Ước chung lớn nhất, Thuật toán Euclid.
        ...
        Vòng lặp giúp chương trình xử lý các thao tác lặp đi lặp lại mà không cần sao chép code. Với người mới học, điểm khó nhất là xác định biến nào cần được cập nhật sau mỗi vòng, điều kiện nào khiến vòng lặp dừng, và giá trị ban đầu của biến tích lũy nên là gì.

        Trong bài này, các chủ đề Python chính là while, toán tử %, tuple assignment. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Ước chung lớn nhất, Thuật toán Euclid. Với các bài
        ...
        Khi gặp một bài toán như `Ước chung lớn nhất bằng thuật toán Euclid`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập hai số nguyên a và b, tính ước chung lớn nhất của hai số.
        ...
        Một số nguyên không âm là ước chung lớn nhất của a và b.
        ...
        1. Đọc hai số nguyên a và b rồi lấy trị tuyệt đối.
2. Lặp khi b khác 0.
3. Thay a bằng b và b bằng a chia lấy dư cho b.
4. Khi vòng lặp dừng, a là ước chung lớn nhất.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: while, toán tử %, tuple assignment.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Ước chung lớn nhất, Thuật toán Euclid. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên, Phép chia lấy dư, while. Khi gặp bài tương tự,
