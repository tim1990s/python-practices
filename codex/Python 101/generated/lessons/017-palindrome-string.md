# 017. Kiểm tra chuỗi palindrome

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Kiểm tra chuỗi palindrome` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: lower(), isalnum(), join(), slicing. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Tính đối xứng.
        ...
        Trong bài này, các chủ đề Python chính là lower(), isalnum(), join(), slicing. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Tính đối xứng. Với các bài
        ...
        Khi gặp một bài toán như `Kiểm tra chuỗi palindrome`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập một chuỗi, bỏ qua khoảng trắng, dấu câu và hoa thường, kiểm tra chuỗi có phải palindrome hay không.
        ...
        In YES nếu là palindrome, ngược lại in NO.
        ...
        Sau khi chuẩn hóa còn amanaplanacanalpanama, chuỗi này đọc xuôi và ngược giống nhau.
        ...
        1. Đọc chuỗi đầu vào.
2. Giữ lại các ký tự chữ hoặc số và chuyển về chữ thường.
3. So sánh chuỗi đã chuẩn hóa với phiên bản đảo ngược.
4. In YES nếu giống nhau, ngược lại in NO.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: lower(), isalnum(), join(), slicing.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Tính đối xứng. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Chuỗi, Cắt chuỗi, So sánh. Khi gặp bài tương tự,
