# 011. Tính tổng từ 1 đến n

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Tính tổng từ 1 đến n` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: for, range(), biến tích lũy. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Tổng cấp số cộng đơn giản.
        ...
        Trong bài này, các chủ đề Python chính là for, range(), biến tích lũy. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Tổng cấp số cộng đơn giản. Với các bài
        ...
        Khi gặp một bài toán như `Tính tổng từ 1 đến n`, bạn nên tự hỏi: đại lượng nào
...
2. Khởi tạo biến tổng bằng 0.
3. Duyệt các số từ 1 đến n và cộng vào tổng.
4. In tổng cuối cùng.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: for, range(), biến tích lũy.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Tổng cấp số cộng đơn giản. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên dương, Vòng lặp for, Biến tổng. Khi gặp bài tương tự,
