# 003. Chu vi và diện tích hình tròn

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Chu vi và diện tích hình tròn` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: float(), math.pi, f-string, định dạng .2f. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Chu vi hình tròn, Diện tích hình tròn.
        ...
        Trong bài này, các chủ đề Python chính là float(), math.pi, f-string, định dạng .2f. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Chu vi hình tròn, Diện tích hình tròn. Với các bài
        ...
        Khi gặp một bài toán như `Chu vi và diện tích hình tròn`, bạn nên tự hỏi: đại lượng nào
        ...
        Nhập bán kính r của hình tròn, in ra chu vi và diện tích, mỗi giá trị làm tròn 2 chữ số thập phân.
        ...
        Hai số thực: chu vi và diện tích, cách nhau bởi dấu cách, làm tròn 2 chữ số thập phân.
        ...
        Với r = 2, chu vi = 2 * pi * r và diện tích = pi * r * r, cả hai xấp xỉ 12.57.
        ...
        1. Đọc bán kính r dưới dạng số thực.
2. Tính chu vi bằng công thức 2 * pi * r.
3. Tính diện tích bằng công thức pi * r * r.
4. In hai kết quả với 2 chữ số thập phân.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: float(), math.pi, f-string, định dạng .2f.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Chu vi hình tròn, Diện tích hình tròn. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số thực, Hằng số pi, Định dạng số. Khi gặp bài tương tự,
