# 014. Kiểm tra số nguyên tố

        # Learning Objectives

        Sau bài học này, bạn cần đạt được bốn mục tiêu. Thứ nhất, bạn hiểu đề bài
        `Kiểm tra số nguyên tố` không chỉ như một yêu cầu tính kết quả, mà như một
        đặc tả nhỏ gồm dữ liệu vào, dữ liệu ra và quy tắc xử lý. Thứ hai, bạn biết
        sử dụng các kiến thức Python liên quan: for, range(), math.isqrt(), break. Thứ ba, bạn kết
        nối được phần lập trình với nền tảng toán học hoặc tư duy logic: Số nguyên tố, Ước số không tầm thường.
        ...
        Trong bài này, các chủ đề Python chính là for, range(), math.isqrt(), break. Bạn không nên
        ...
        Phần toán học hoặc tư duy nền tảng của bài là: Số nguyên tố, Ước số không tầm thường. Với các bài
        ...
        Khi gặp một bài toán như `Kiểm tra số nguyên tố`, bạn nên tự hỏi: đại lượng nào
        ...
        29 chỉ có hai ước dương là 1 và 29.
        ...
        1. Đọc số nguyên n.
2. Nếu n nhỏ hơn 2 thì không phải số nguyên tố.
3. Kiểm tra các ước từ 2 đến căn bậc hai của n.
4. Nếu tìm thấy ước thì in NO, nếu không thì in YES.
...
if __name__ == "__main__":
    main()
        ...
        Để học sâu hơn, hãy đọc lại tài liệu Python về các chủ đề: for, range(), math.isqrt(), break.
        Sau đó xem lại phần toán hoặc tư duy nền tảng: Số nguyên tố, Ước số không tầm thường. Bạn cũng nên
        luyện lại các kiến thức tiên quyết: Số nguyên, Ước số, Vòng lặp, if. Khi gặp bài tương tự,
