# Chương trình tính tổng dãy số nhập từ bàn phím
#
...
# Kết quả là: chương trình tính tổng dãy số nhập từ bàn phím rồi in kết quả.
#
# Lưu ý:
...
# - Thực hiện yêu cầu: tính tổng dãy số nhập từ bàn phím.
