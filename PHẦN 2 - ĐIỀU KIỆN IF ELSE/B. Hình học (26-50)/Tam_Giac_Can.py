# Chương trình kiểm tra tam giác cân
#
...
# cạnh thứ hai = 4
# cạnh thứ ba = 5
# Kết quả là: chương trình kiểm tra tam giác cân và in thông báo phù hợp.
#
# Lưu ý:
# - Ba cạnh phải lớn hơn 0.
# - Ba cạnh không tạo thành tam giác.
# - Đây không phải là tam giác cân.
#
# Ý tưởng:
...
# - Thực hiện yêu cầu: kiểm tra tam giác cân.
