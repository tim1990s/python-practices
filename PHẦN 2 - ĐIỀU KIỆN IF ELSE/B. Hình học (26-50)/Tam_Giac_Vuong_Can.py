# Chương trình kiểm tra tam giác vuông cân
#
...
# cạnh thứ hai = 4
# cạnh thứ ba = 5
# Kết quả là: chương trình kiểm tra tam giác vuông cân và in thông báo phù hợp.
#
# Lưu ý:
# - Ba cạnh phải lớn hơn 0.
# - Ba cạnh không tạo thành tam giác.
# - Đây không phải là tam giác vuông cân.
#
# Ý tưởng:
...
# - Thực hiện yêu cầu: kiểm tra tam giác vuông cân.
...
if a <= 0 or b <= 0 or c <= 0:
    ...
    if la_vuong and la_can:
        ...
        print("Đây không phải là tam giác vuông cân")
