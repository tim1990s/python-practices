# Chương trình chọn nghiệm lớn nhất của phương trình bậc hai
#
...
# hệ số b = -3
# hệ số c = 2
# Kết quả là: chương trình chọn nghiệm lớn nhất của phương trình bậc hai rồi in nghiệm được chọn.
#
# Lưu ý:
...
# - Thực hiện yêu cầu: chọn nghiệm lớn nhất của phương trình bậc hai.
...
if a == 0:
    ...
    if delta < 0:
        ...
        print("Nghiệm lớn nhất là:", max(x1, x2))
