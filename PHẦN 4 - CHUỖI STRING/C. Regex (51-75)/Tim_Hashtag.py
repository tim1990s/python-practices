# Chương trình tìm hashtag bằng regex
#
# Yêu cầu:
# - Viết chương trình tìm hashtag bằng regex.
...
hashtags = re.findall(r"(?<!\w)#\w+", van_ban, flags=re.UNICODE)
if not hashtags:
    print("Không tìm thấy hashtag")
else:
    print("Hashtag tìm thấy:")
