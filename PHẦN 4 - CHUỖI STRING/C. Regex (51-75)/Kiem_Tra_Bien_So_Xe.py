# Chương trình kiểm tra biển số xe bằng regex
#
# Yêu cầu:
# - Viết chương trình kiểm tra biển số xe bằng regex.
...
import re
bien_so = input("Nhập biển số xe: ").upper().replace(" ", "")
mau = r"^\d{2}[A-Z]\d?-?\d{4,5}$"
print("Biển số xe hợp lệ" if re.fullmatch(mau, bien_so) else "Biển số xe không hợp lệ")
