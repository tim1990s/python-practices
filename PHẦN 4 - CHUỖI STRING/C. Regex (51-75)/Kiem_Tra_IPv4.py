# Chương trình kiểm tra IPv4 bằng regex
#
# Yêu cầu:
# - Viết chương trình kiểm tra IPv4 bằng regex.
...
import re
ip = input("Nhập địa chỉ IPv4: ")
mau = r"^(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}$"
print("IPv4 hợp lệ" if re.fullmatch(mau, ip) else "IPv4 không hợp lệ")
