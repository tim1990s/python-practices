# Chương trình kiểm tra mã số thuế bằng regex
#
# Yêu cầu:
# - Viết chương trình kiểm tra mã số thuế bằng regex.
...
import re
mst = input("Nhập mã số thuế: ")
mau = r"^\d{10}(-\d{3})?$"
print("Mã số thuế hợp lệ" if re.fullmatch(mau, mst) else "Mã số thuế không hợp lệ")
