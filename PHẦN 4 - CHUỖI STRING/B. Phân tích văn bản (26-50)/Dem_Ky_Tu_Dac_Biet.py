# Chương trình đếm ký tự đặc biệt
#
# Yêu cầu:
# - Viết chương trình đếm ký tự đặc biệt.
...
so_luong = sum(1 for ky_tu in chuoi if not ky_tu.isalnum() and not ky_tu.isspace())
print("Số ký tự đặc biệt:", so_luong)
